...
You must add SES policy access to the role mapped to the /share endpoint. On dev, it might look something like this: medifax-backend-customers-dev-us-east-1-lambdaRole
